...
@colors_bp.route('/')
@colors_bp.route('/<color_code>')
def view_color(color_code: str = f'{list(DATA_COLOR_PROFILES.keys())[0]}'):
    
    selected_item = DATA_COLOR_PROFILES.get(color_code)
